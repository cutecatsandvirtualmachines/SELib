...
namespace svm {
    struct VmcbControlArea
    {
        ...
        union
        {
            ...
            struct
            {
                ...
                unsigned long long ErrorCodeValid : 1;
                unsigned long long Reserved : 19;
                unsigned long long Valid : 1;
                unsigned long long ErrorCode : 32;
            } layout;
        } EventInjection;// 15.20 Event Injection
        ...
        unsigned long long VmcbCleanBits;
    ...
    struct Vmcb
    {
        ...
        [[nodiscard]] unsigned long long InstructionLength() const
        {
            return ControlArea.NextRip - StateSaveArea.Rip;
        }

        auto& Rax()
        {
            return StateSaveArea.Rax;
        }

        auto& Rsp()
        {
            return StateSaveArea.Rsp;
        }

        auto& Rip()
        {
            return StateSaveArea.Rip;
        }

        auto& Cr3()
        {
            return StateSaveArea.Cr3;
        }

        auto& NestedPageTableCr3()
        {
            return ControlArea.NestedPageTableCr3;
        }

        auto& RFlags()
        {
            return StateSaveArea.Rflags;
        }

        void InjectException(unsigned long long Vector);
        void InjectException(unsigned long long Vector, unsigned long long ErrorCode);
    };
